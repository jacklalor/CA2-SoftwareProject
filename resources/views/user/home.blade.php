    ...
    <div class="bg-gray-100 dark:bg-gray-900">
        ...
        <div class="py-20 sm:py-32 lg:py-40">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <a href="{{ route('user.dashboard') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-lg shadow-lg transition duration-300">
                        Get Started
                    </a>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800">
            <div class="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-gray-100 leading-tight mb-8">
